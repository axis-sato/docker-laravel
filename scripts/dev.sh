...
setup_laravel_ide_helper () {
    docker-compose exec app bash -c "cd \"./$PROJECT_NAME\" && \
...
create_project () {
    docker-compose exec app composer create-project --prefer-dist "laravel/laravel=$LARAVEL_VERSION" "$PROJECT_NAME" && \
